...
/**
 * Элегантное решение со складыванием половинок. Но, к сожалению...
 * <p/>
 * Проверяет границы интервалов в каждом узле дерева, задавая таким образом много лишних вопросов.
 * <p/>
