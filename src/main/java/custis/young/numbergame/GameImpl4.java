...
/**
 * В целом, такое «десятичное» дерево сильно излишне. Принципиальной разницы в логарифмическом росте нет,
 ...
 * (с количеством проверок около 10^10), но возвращается с правильным ответом.
 * <p/>
 * Из-за не совсем корректной проверки, если загаданное число равно верхней границе,
 * уйдет в такую же долгую рекурсию, но выйдет из нее уже с неправильным ответом.
 * <p/>
